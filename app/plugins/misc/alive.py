...
async def get_alive_text() -> str:
    ...
    return (
        ...
        f"Um User-Bot simples para Telegram criado por {user_info.first_name}.\n"
        f"\n › Usuário       :   <code>{user_info.first_name}</code>"
...
def get_alive_buttons(client: BOT):
    ...
    return InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton(text="Grupo de Suporte", url="https://t.me/plainub")],
        ]
    )
